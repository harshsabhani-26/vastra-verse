...
export default function ProductsError({
    ...
    useEffect(() => {
        console.error('[ERROR:ADMIN_PRODUCTS]', error);
    }, [error]);
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-8">
            <div className="bg-white rounded-lg border border-stone-200 shadow-sm p-8 max-w-md w-full text-center">
                ...
                <h2 className="text-lg font-serif text-[#1C1917] mb-2">Products failed to load</h2>
                <p className="text-sm text-stone-500 mb-1">
                    An error occurred while loading the products page.
                </p>
                {error.digest && (
