...
import { Upload, Save, Eye, Plus, X } from "lucide-react";
...
export default function AddProductPage() {
    ...
    async function handleSubmit(saveAction: "DRAFT" | "PUBLISH" | "ADDANOTHER") {
        setLoading(true);
        ...
        try {
            ...
            if (res.ok) {
                if (saveAction === "ADDANOTHER") {
                    ...
                    setDiscount("");
                    setProductImages([]);
                    alert("Product saved! You can add another.");
                } else {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 pb-20">
            <div className="flex items-center justify-between">
                <h1 className="text-xl md:text-2xl font-bold tracking-tight text-[#1C1917]">Add New Saree</h1>
                ...
                <div className="sticky bottom-0 bg-white p-6 rounded-lg border-2 border-stone-300 shadow-lg">
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Button
                            ...
                            variant="outline"
                            className="flex-1 md:flex-none min-w-[180px] border-primary text-primary hover:bg-primary hover:text-white"
                            disabled={loading}
                        >
