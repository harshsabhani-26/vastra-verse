        ...
        <div className="bg-[#FDFBF7] min-h-screen">
            ...
            <div className="bg-white border-b border-stone-200">
                <div className="container mx-auto px-4 py-8 md:py-12 text-center">
                    <h1 className="font-serif text-3xl md:text-5xl text-[#1C1917]">Contact Us</h1>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-12 md:py-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 max-w-6xl mx-auto">
                    ...
                    <div className="space-y-8">
                        <div className="prose prose-stone max-w-none text-[#1C1917]">
                        ...
                        <div className="space-y-6">
                            <div>
                                <p className="text-xs font-bold tracking-widest text-[#1C1917] mb-1">GENERAL QUERIES</p>
                                <p className="text-sm text-stone-600 mb-1">+91 9725714184</p>
                                <a href="mailto:yogitextile43@gmail.com" className="text-sm text-stone-600 hover:text-[#1C1917] underline">yogitextile43@gmail.com</a>
                            </div>
                        </div>

                        <div className="pt-8 border-t border-stone-200 space-y-4 text-sm text-stone-600">
                            <h3 className="font-serif text-lg text-[#1C1917]">Vayana Heritage Private Limited</h3>
                            <p>
                                <span className="font-semibold block text-[#1C1917]">CIN:</span> U17116MH1995PTC086449
                            </p>
                            <p>
                                <span className="font-semibold block text-[#1C1917]">Registered Office Address:</span>
                                20/C Pali Village, Opp. SAISA Club, Off 16th Rd, Bandra (W)
                            </p>
                            <p>
                                <span className="font-semibold block text-[#1C1917]">Corporate Office Address:</span>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full border-b border-stone-300 py-2 text-[#1C1917] focus:outline-none focus:border-[#1C1917] transition-colors bg-transparent placeholder:text-stone-300"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full border-b border-stone-300 py-2 text-[#1C1917] focus:outline-none focus:border-[#1C1917] transition-colors bg-transparent"
                                    >
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    onChange={handleInputChange}
                                    rows={4}
                                    className="w-full border-b border-stone-300 py-2 text-[#1C1917] focus:outline-none focus:border-[#1C1917] transition-colors bg-transparent placeholder:text-stone-300 resize-none"
                            ...
                            <div className="flex items-start gap-3 py-2">
                                ...
                                <label htmlFor="newsletter" className="text-sm text-stone-600">
                                    Sign up for our newsletters and stay up to date on the latest news, collections and events from Vayana Heritage.
                                </label>
                            </div>

                            <div className="space-y-4">
                                <p className="text-xs text-stone-400">
                                    I understand and agree that registration on or use of the site constitutes agreement to its <Link href="/privacy-policy" className="underline hover:text-[#1C1917]">Privacy Policy</Link> and <Link href="/terms" className="underline hover:text-[#1C1917]">Terms and Conditions</Link>.
                                </p>
                                <p className="text-xs text-stone-400">
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-[#1C1917] hover:bg-[#333333] text-white rounded-none uppercase tracking-widest h-12"
                            >
                                Submit
                            </Button>
                        </form>
