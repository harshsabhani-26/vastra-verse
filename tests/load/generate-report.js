#!/usr/bin/env node
/**
 * VastraaVerse — k6 HTML Report Generator
 *
...
<title>VastraaVerse Load Test Report — ${mode.toUpperCase()}</title>
<style>
  :root {
...
<div class="header">
  <div>
    <h1>⚡ VastraaVerse Load Test Report</h1>
    <div class="meta">
...
<footer>
  Generated by VastraaVerse Load Test Suite • ${new Date().toISOString()}
</footer>
