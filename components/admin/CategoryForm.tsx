...
export default function CategoryForm({ category, mode, mainCategories = [] }: CategoryFormProps) {
    ...
    const [isSlugAutoGenerated, setIsSlugAutoGenerated] = useState(mode === "add");

    // Auto-generate slug from name
    useEffect(() => {
        if (mode === "add" && isSlugAutoGenerated) {
            const nameSlug = name
                .toLowerCase()
                .replace(/[^a-z0-9]+/g, "-")
                .replace(/(^-|-$)/g, "");
            ...
            if (selectedMainCategoryId) {
                ...
                if (mainCat) {
                    const mainCatSlug = mainCat.name
                        .toLowerCase()
                        .replace(/[^a-z0-9]+/g, "-")
                        .replace(/(^-|-$)/g, "");
                    setSlug(`${mainCatSlug}/${nameSlug}`);
                    return;
                }
            }
    ...
    }, [name, mode, selectedMainCategoryId, mainCategories, isSlugAutoGenerated]);
                        ...
                        {mainCategories && mainCategories.length > 0 && (
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-stone-500">
                                    Selecting a main category will auto-prefix the URL slug.
                                </p>
                            </div>
                        )}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Input
                                    ...
                                    title="Only lowercase letters, numbers, hyphens, and slashes allowed"
                                    required
                                />
                            </div>
                            <p className="text-xs text-stone-500">
                                Auto-generated from name. Use lowercase letters, numbers, slashes, and hyphens only.
                            </p>
                        </div>
