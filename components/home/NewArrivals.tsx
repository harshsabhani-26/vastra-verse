...
export async function NewArrivals() {
    ...
    return (
        <section className="w-full pt-[40px] pb-[30px] md:pt-[80px] md:pb-[40px] bg-white">
            <div className="container mx-auto px-4 md:px-[24px]">
                        ...
                        <div key={product.id} className="group flex flex-col min-w-[160px] max-w-[160px] w-[45vw] snap-start shrink-0 md:w-auto md:min-w-0 md:max-w-none">
                            ...
                            <div className="flex flex-col items-start text-left">
                                ...
                                {product.isNewArrival && (
                                    <span className="inline-block bg-[#e6f4ea] text-[#1a7f37] text-[11px] font-sans font-semibold px-[10px] py-[3px] rounded-full mb-[6px] border border-[#a3d9b1]">
                                        Ready to Ship
                                    </span>
                                )}
                                ...
                                <Link href={`/shop/${product.id}`}>
                                    <h3 className="font-sans text-[14px] md:text-[15px] text-[#172026] font-normal leading-[1.4] mb-[6px] line-clamp-2 hover:text-primary transition-colors">
                                        {product.name}
                                    </h3>
                                </Link>
                ...
                <div className="mt-[32px] md:mt-[48px] flex justify-center">
                    <Link href="/shop?sort=newest" className="inline-block">
                        <Button
                            variant="outline"
