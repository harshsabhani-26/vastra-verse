        ...
        <section className="w-full bg-primary py-16">
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
                    {/* Left - Heading */}
                    <h3 className="text-white text-base md:text-lg font-serif tracking-[0.05em] text-center md:text-left leading-relaxed">
                        Enter Into The World of <br className="hidden md:block" />
                        <span className="text-secondary italic">Vastra Verse</span>
                    </h3>

                    {/* Right - Email Input */}
                    <form onSubmit={handleSubmit} className="flex items-center gap-4 w-full md:w-auto">
